// Calcular a área de diferentes formas geométricas usando funções para separar os procedimentos
...
// Função para exibir um menu e devolver o resultado escolhido
function exibirMenu() {
  return prompt(
